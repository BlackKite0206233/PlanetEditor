...
public class Planet : MonoBehaviour {
    ...
    const float  DEFLAUT_RADIUOS    = 100;
    const int    DEFLAUT_RESOLUTION = 30;
    const int    THETA              = 360;
    const string MATERIAL_NAME      = "VR/SpatialMapping/Wireframe";
    ...
    void Start () {
        ...
        Mesh         mesh = new Mesh();
        GameObject   obj  = GameObject.Find("planet");
